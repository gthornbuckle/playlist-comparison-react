...
function DeleteButton(props){
    ...
    return (
        ...
        >
            <motion.svg className="relative bottom-2" width="32" height="32" viewBox="0 0 18.76 6.03" stroke="#14b8a6" strokeWidth="1" strokeLinecap="round" fill="none"
                initial={false}
            ...
            <motion.svg className="relative bottom-5" width="32" height="32" viewBox="0 0 16.8 19.06" stroke="#14b8a6" strokeWidth="1" strokeLinecap="round" fill="none"
                initial={false}
                animate={isHovered ? "hover" : "initial"}
                variants={variants}
            >
