...
function DeleteButton(props){
    ...
    return (
        ...
        >
            <motion.svg className="absolute right-2 top-1" width="20" height="20" viewBox="0 0 18.76 6.03" stroke="#14b8a6" strokeWidth="1.5" strokeLinecap="round" fill="none"
                initial={false}
            ...
            <motion.svg className="absolute right-2 top-4" width="20" height="20" viewBox="0 0 16.8 19.06" stroke="#14b8a6" strokeWidth="1.5" strokeLinecap="round" fill="none"
                initial={false}
                animate={isHovered ? "hover" : "initial"}
                variants={variants}
            >
