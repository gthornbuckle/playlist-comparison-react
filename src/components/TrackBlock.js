            ...
            <motion.div className="h-[200px] cursor-pointer" onClick={() =>{props.expandinfo([props.name, props.artists.join(' & '), props.duration, props.url, props.artwork])}}>
                ...
                onClick={props.expand}>
                    ...
                    <motion.div className="overflow-hidden">
                        <motion.div className="pl-5 pt-2 flex flex-col items-start text-left font-bold tracking-wide absolute whitespace-normal" style={{color: props.playlistTheme[3]}}>
